...
class UserUtils:
    ...
    def compare_two_users(self, embs1: Tensor, embs2: Tensor) -> Dict:
        ...
        embs1Centered = embs1Mean - torch.mean(embs1Mean, dim=0)
        embs2Centered = embs2Mean - torch.mean(embs2Mean, dim=0)
        embs1MeanNormCentered = F.normalize(embs1Centered, dim=0)
        embs2MeanNormCentered = F.normalize(embs2Centered, dim=0)
        ...
        covar = torch.sum(embs1MeanNormCentered * embs2MeanNormCentered).item()
